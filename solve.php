...
<div class="container">
	...
	<form method="post" action="eval.php">
      ...
      ?>
		...
		<br/>
		<textarea style="font-family: mono; height:400px;" class="span9" name="soln" id="text"><?php if(!($num == 0)) echo($fields['soln']); else echo "// For Java users : Name your class 'Solution'";?>
</textarea>
		<br/>
